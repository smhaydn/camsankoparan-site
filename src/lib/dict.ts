...
const tr = {
  ...
  cookieBanner: {
    ...
    body: "Sitenin çalışması için gereken çerezleri kullanıyoruz. Ziyaretin nasıl geçtiğini ölçmek ve reklamlarımızın sonucunu görmek için ek çerezleri ise ancak siz izin verirseniz kullanırız.",
    ...
    analytics: "Analitik",
    analyticsDesc: "Hangi sayfaların ilgi gördüğünü anlamamızı sağlar (Google Analytics).",
    marketing: "Pazarlama",
    marketingDesc: "Reklamlarımızın sonuç verip vermediğini ölçer (Meta, Google).",
  },
  legal: {
...
const en: typeof tr = {
  ...
  cookieBanner: {
    ...
    body: "We use the cookies the site needs to work. Additional cookies that measure how your visit went and whether our advertising works are used only if you allow them.",
    ...
    analytics: "Analytics",
    analyticsDesc: "Helps us see which pages draw interest (Google Analytics).",
    marketing: "Marketing",
    marketingDesc: "Measures whether our advertising works (Meta, Google).",
  },
  legal: {
